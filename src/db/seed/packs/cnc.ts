...
export const cncSeedPack: SeedPack = {
  key: "cnc",
  site: {
    companyNameZh: "精密数控组件有限公司",
    companyNameEn: "Precision CNC Components Co., Ltd.",
    taglineZh: "高精度数控加工，服务全球OEM买家。",
