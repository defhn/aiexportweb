  ...
  products: [
    {
      ...
      detailsZh:
        "可按产品尺寸和节拍时间定制，系统可与机器人、视觉检测和下游工位集成。",
      detailsEn:
      ...
      defaultFields: {
        ...
        process: { valueZh: "钣金加工", valueEn: "Fabrication and assembly", visible: true },
        size: { valueZh: "按生产线定制", valueEn: "Customized by line layout", visible: true },
        application: {
          valueZh: "包装、装配和检测线",
    ...
    },
    {
      ...
      defaultFields: {
        ...
        process: { valueZh: "焊接 + 组装", valueEn: "Welding + assembly", visible: true },
        application: {
          valueZh: "自动化工位转移",
