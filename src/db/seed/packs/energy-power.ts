    ...
    "home": [
      {
        ...
        "payloadJson": {
          ...
          "description": "Delivering switchgear, energy storage, and turnkey electrical systems with global project support.",
    ...
    "about": [
      {
        ...
        "payloadJson": {
          ...
          "description": "From panel assembly to factory testing, we control quality and delivery for export projects."
        }
      }
    ],
    "contact": [
      {
        ...
        "payloadJson": {
          ...
          "description": "Send voltage level, capacity target, and destination market for a tailored proposal."
        }
      }
    ]
  },
  "categories": [
    {
      ...
      "summaryEn": "Low-voltage distribution solutions for industrial parks and commercial buildings.",
      "sortOrder": 10,
      "isFeatured": true
    },
    {
      ...
      "summaryEn": "Commercial and industrial battery systems for peak shaving and backup power.",
      "sortOrder": 20,
      "isFeatured": true
    }
  ],
  "products": [
    {
      ...
      "shortDescriptionEn": "Modular low-voltage switchgear for multi-circuit power distribution and on-site expansion.",
      "detailsZh": "可按项目需求配置断路器、母线和保护方案，支持工厂 FAT 验证和出口包装。",
      "detailsEn": "Configurable breakers, busbars, and protection schemes with factory FAT validation and export packaging.",
      "seoTitle": "Low Voltage Switchgear Manufacturer",
      "seoDescription": "Source project-ready low voltage switchgear with customizable configurations and export support.",
      "sortOrder": 10,
      "isFeatured": true,
      "defaultFields": {
        "model": {
        ...
        "material": {
          "valueZh": "镀锌钢板",
          "valueEn": "Galvanized steel enclosure",
          "visible": true
        },
        "application": {
          "valueZh": "工商业配电",
          "valueEn": "Industrial and commercial distribution",
          "visible": true
        },
        "moq": {
          "valueZh": "1 套",
    ...
    },
    {
      ...
      "shortDescriptionEn": "Integrated battery energy storage solution for commercial and industrial sites.",
      "detailsZh": "集成电池包、PCS、温控和消防模块，支持并网削峰和备用电源模式。",
      "detailsEn": "Integrated battery packs, PCS, thermal management, and fire protection for peak shaving and backup modes.",
      "seoTitle": "Commercial Battery Storage Cabinet Supplier",
      "seoDescription": "Deploy scalable C&I battery storage cabinets with smart control and export-ready documentation.",
      "sortOrder": 20,
      "isFeatured": false,
      "defaultFields": {
        "model": {
        ...
        "application": {
          "valueZh": "削峰填谷 / 备用供电",
          "valueEn": "Peak shaving / Backup supply",
          "visible": true
        },
        "moq": {
          "valueZh": "1 套",
  ...
  "blogPosts": [
    {
      ...
      "excerptEn": "A practical checklist to define battery storage configurations early and reduce project rework.",
      "contentZh": "建议重点确认负荷曲线、并网条件、放电时长、安装空间与消防要求。",
      "contentEn": "Focus on load profile, grid interconnection conditions, discharge duration, installation space, and fire safety requirements.",
