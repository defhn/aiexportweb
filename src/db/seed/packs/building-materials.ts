export const buildingMaterialsSeedPack: SeedPack = {
  ...
  "site": {
    ...
    "addressEn": "Building Materials Industrial Zone, Nanhai District, Foshan, Guangdong, China"
  },
  "pages": {
    "home": [
      {
        ...
        "payloadJson": {
          ...
          "description": "Support contractors and distributors with export-ready metal panels, railings, and project documentation.",
    ...
    "about": [
      {
        ...
        "payloadJson": {
          ...
          "description": "We help buyers coordinate finish options, dimensions, and shipment schedules for construction projects."
        }
      }
    ],
    "contact": [
      {
        ...
        "payloadJson": {
          ...
          "description": "Our team can help match finishes, thickness, and package requirements for your project."
        }
      }
    ]
  },
  "categories": [
    {
      ...
      "summaryEn": "Ideal for facades, interior cladding, and architectural feature walls.",
      "sortOrder": 10,
      "isFeatured": true
    },
    {
      ...
      "summaryEn": "Railing systems for commercial and residential construction projects.",
      "sortOrder": 20,
      "isFeatured": true
    }
  ],
  "products": [
    {
      ...
      "shortDescriptionEn": "A lightweight, high-flatness panel solution for facades and interior walls.",
      "detailsZh": "可定制颜色、厚度和固定结构，支持项目供货和出口运输。",
      "detailsEn": "Available in customized colors, thicknesses, and fixing structures for project supply and export shipping.",
      "seoTitle": "Aluminum Honeycomb Wall Panel Manufacturer",
      "seoDescription": "Order architectural aluminum honeycomb wall panels with custom finishes, thickness options, and export support.",
      "sortOrder": 10,
      "isFeatured": true,
      "defaultFields": {
        "model": {
        ...
        "material": {
          "valueZh": "铝板 + 蜂窝芯",
          "valueEn": "Aluminum sheet + honeycomb core",
          "visible": true
        },
        "size": {
          "valueZh": "1220 x 2440 mm",
          "valueEn": "1220 x 2440 mm",
          "visible": true
        },
        "surface_treatment": {
          "valueZh": "PVDF 涂层",
    ...
    },
    {
      ...
      "shortDescriptionEn": "A modern railing system for commercial spaces and residential developments.",
      "detailsZh": "可按项目尺寸、玻璃厚度和表面处理定制，提供完整五金配件。",
      "detailsEn": "Customizable by project dimensions, glass thickness, and finish, with full hardware supply available.",
      "seoTitle": "Stainless Steel Glass Railing Supplier",
      "seoDescription": "Source export-ready stainless steel glass railings for building and renovation projects.",
      "sortOrder": 20,
      "isFeatured": false,
      "defaultFields": {
        "model": {
        ...
        "material": {
          "valueZh": "不锈钢 304 / 316",
          "valueEn": "Stainless steel 304 / 316",
          "visible": true
        },
        "surface_treatment": {
          "valueZh": "拉丝 / 镜面",
    ...
    },
    {
      ...
      "seoTitle": "building-materials 产品 3",
    ...
    },
    {
      ...
      "detailsZh": "详细描述（中文）……",
      "detailsEn": "Detailed description (English)…",
      "seoTitle": "building-materials 产品 4",
      "seoDescription": "适用于 building-materials 行业的高质量产品。",
      "sortOrder": 5,
      "isFeatured": false,
      "defaultFields": {
    ...
    },
    {
      ...
      "detailsZh": "详细描述（中文）……",
      "detailsEn": "Detailed description (English)…",
      "seoTitle": "building-materials 产品 5",
      "seoDescription": "适用于 building-materials 行业的高质量产品。",
      "sortOrder": 6,
      "isFeatured": false,
      "defaultFields": {
    ...
    },
    {
      ...
      "detailsZh": "详细描述（中文）……",
      "detailsEn": "Detailed description (English)…",
      "seoTitle": "building-materials 产品 6",
      "seoDescription": "适用于 building-materials 行业的高质量产品。",
      "sortOrder": 7,
      "isFeatured": false,
      "defaultFields": {
    ...
    },
    {
      ...
      "detailsZh": "详细描述（中文）……",
      "detailsEn": "Detailed description (English)…",
      "seoTitle": "building-materials 产品 7",
      "seoDescription": "适用于 building-materials 行业的高质量产品。",
      "sortOrder": 8,
      "isFeatured": false,
      "defaultFields": {
    ...
    },
    {
      ...
      "detailsZh": "详细描述（中文）……",
      "detailsEn": "Detailed description (English)…",
      "seoTitle": "building-materials 产品 8",
      "seoDescription": "适用于 building-materials 行业的高质量产品。",
      "sortOrder": 9,
      "isFeatured": false,
      "defaultFields": {
    ...
    },
    {
      ...
      "detailsZh": "详细描述（中文）……",
      "detailsEn": "Detailed description (English)…",
      "seoTitle": "building-materials 产品 9",
      "seoDescription": "适用于 building-materials 行业的高质量产品。",
      "sortOrder": 10,
      "isFeatured": false,
      "defaultFields": {
    ...
    },
    {
      ...
      "detailsZh": "详细描述（中文）……",
      "detailsEn": "Detailed description (English)…",
      "seoTitle": "building-materials 产品 10",
      "seoDescription": "适用于 building-materials 行业的高质量产品。",
      "sortOrder": 11,
      "isFeatured": false,
      "defaultFields": {
  ...
  "blogPosts": [
    {
      ...
      "excerptEn": "A practical comparison guide for distributors and project buyers selecting panel systems.",
      "contentZh": "买家应比较平整度、涂层耐久性、防火等级、固定方式和运输保护。",
      "contentEn": "Buyers should compare flatness, coating durability, fire rating, fixing method, and shipping protection.",
