    ...
    "home": [
      {
        ...
        "payloadJson": {
          ...
          "description": "Create gift sets, stationery, and lifestyle items with custom branding, packaging, and export-ready support.",
      ...
      },
      {
        ...
        "payloadJson": {
          ...
          "description": "Send your concept, target price, and packaging needs, and we’ll prepare a practical production plan.",
    ...
    "about": [
      {
        ...
        "payloadJson": {
          ...
          "description": "We handle sourcing, customization, assembly, packaging, and final inspection for export programs."
        }
      }
    ],
    "contact": [
      {
        ...
        "payloadJson": {
          ...
          "description": "Tell us the target audience, packaging direction, and order volume for a tailored proposal."
        }
      }
    ]
  },
  ...
  "products": [
    {
      ...
      "detailsZh": "支持香型定制、盒型设计和品牌烫金，适合零售和企业礼品渠道。",
      "detailsEn": "Supports scent customization, box design, and branded foil stamping for retail and corporate gifting.",
      ...
      "defaultFields": {
        ...
        "material": {
          "valueZh": "玻璃 + 纸盒",
          "valueEn": "Glass + paper box",
          "visible": true
        },
        "process": {
          "valueZh": "灌装 + 包装",
          "valueEn": "Filling + packaging",
          "visible": true
        },
        "application": {
          "valueZh": "节日礼品",
          "valueEn": "Seasonal gifting",
          "visible": true
        },
        "moq": {
          "valueZh": "500 套",
    ...
    },
    {
      ...
      "detailsZh": "支持封面材质、内页格式和包装方式定制，满足品牌礼品需求。",
      "detailsEn": "Supports custom cover materials, page formats, and packaging methods for branded gifting.",
      ...
      "defaultFields": {
        ...
        "process": {
          "valueZh": "压印 + 组装",
          "valueEn": "Embossing + assembly",
          "visible": true
        },
        "application": {
          "valueZh": "礼品文具",
          "valueEn": "Gift stationery",
          "visible": true
        },
        "moq": {
          "valueZh": "300 件",
      ...
      "customFields": [
        {
          "labelZh": "封面工艺",
          "labelEn": "Cover Finish",
          "valueZh": "激光雕刻",
          "valueEn": "Laser engraving",
          "visible": true,
          "sortOrder": 10
        }
      ]
