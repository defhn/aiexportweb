    ...
    home: [
      {
        ...
        payloadJson: {
          ...
          description:
            "Support product launches with dependable electronics development, assembly, packaging, and export fulfillment.",
      ...
      },
      {
        ...
        sortOrder: 30,
        payloadJson: {
          slugs: ["smart-accessories", "portable-devices"],
        },
      },
      {
        moduleKey: "final-cta",
        ...
        payloadJson: {
          ...
          description:
            "Share your product brief, target market, and packaging needs, and we’ll prepare a clear manufacturing proposal.",
    ...
    about: [
      {
        ...
        payloadJson: {
          ...
          description:
            "We coordinate engineering, sourcing, assembly, and packaging with tight quality control for launch-ready delivery.",
        },
      },
    ],
    contact: [
      {
        ...
        payloadJson: {
          ...
          description:
            "Send target specs, packaging preferences, and forecast quantities for a tailored electronics proposal.",
        },
      },
    ],
  },
  ...
  products: [
    {
      ...
      detailsZh:
        "支持多设备兼容、礼盒包装和 OEM 定制外观，适合品牌渠道和分销商。",
      detailsEn:
        "Supports multi-device compatibility, gift-box packaging, and OEM customization for brands and distributors.",
      ...
      isFeatured: true,
      defaultFields: {
        model: { valueZh: "WCD-100", valueEn: "WCD-100", visible: true },
        material: { valueZh: "ABS + PC", valueEn: "ABS + PC", visible: true },
        process: { valueZh: "注塑 + 装配", valueEn: "Injection molding + assembly", visible: true },
        size: { valueZh: "可定制", valueEn: "Customizable", visible: true },
        application: { valueZh: "桌面充电", valueEn: "Desktop charging", visible: true },
        moq: { valueZh: "500 件", valueEn: "500 pcs", visible: true },
        lead_time: { valueZh: "18-28 天", valueEn: "18-28 days", visible: true },
        supply_ability: { valueZh: "每月 50,000 件", valueEn: "50,000 pcs per month", visible: true },
        certification: { valueZh: "CE / FCC", valueEn: "CE / FCC", visible: true },
      },
      customFields: [{ labelZh: "接口", labelEn: "Interface", valueZh: "USB-C", valueEn: "USB-C", visible: true, sortOrder: 10 }],
    },
    {
      nameZh: "便携蓝牙音箱",
      ...
      detailsZh:
        "支持多种表面处理、定制包装和礼盒套装，适合品牌出海。",
      detailsEn:
        "Supports multiple finishes, custom packaging, and gift sets for brand export programs.",
      ...
      isFeatured: false,
      defaultFields: {
        model: { valueZh: "PBS-260", valueEn: "PBS-260", visible: true },
        material: { valueZh: "ABS + 金属网", valueEn: "ABS + metal mesh", visible: true },
        process: { valueZh: "注塑 + 喇叭装配", valueEn: "Injection molding + speaker assembly", visible: true },
        application: { valueZh: "家庭与户外", valueEn: "Home and outdoor", visible: true },
        moq: { valueZh: "300 件", valueEn: "300 pcs", visible: true },
        lead_time: { valueZh: "20-30 天", valueEn: "20-30 days", visible: true },
        certification: { valueZh: "CE / RoHS", valueEn: "CE / RoHS", visible: true },
      },
      customFields: [{ labelZh: "续航", labelEn: "Battery Life", valueZh: "8 小时", valueEn: "8 hours", visible: true, sortOrder: 10 }],
    },
  ],
  blogCategories: [{ nameZh: "电子产品方案", nameEn: "Electronics Solutions", slug: "electronics-solutions" }],
  blogPosts: [
    {
      ...
      tags: ["packaging", "consumer-electronics"],
      publishedAt: "2026-04-05T09:00:00.000Z",
    },
  ],
  featuredCategorySlugs: ["smart-accessories", "portable-devices"],
  featuredProductSlugs: ["wireless-charging-dock"],
};
