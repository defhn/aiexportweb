    ...
    home: [
      {
        ...
        payloadJson: {
          ...
          description:
            "Providing compliant consumables and rehabilitation equipment with export-ready documentation.",
      ...
      },
      {
        ...
        sortOrder: 30,
        payloadJson: {
          slugs: ["medical-consumables", "rehabilitation-devices"],
        },
      },
    ],
    about: [
      {
        ...
        payloadJson: {
          ...
          description:
            "Clean assembly environment, process controls, and documented final inspections for export orders.",
        },
      },
    ],
    contact: [
      {
        ...
        payloadJson: {
          ...
          description:
            "Send product list, certifications needed, and destination country for a fast quotation.",
        },
      },
    ],
  },
  ...
  products: [
    {
      ...
      detailsEn:
        "Supports multi-layer filtration and batch traceability with export testing reports.",
      seoTitle: "Disposable Medical Mask Supplier",
      seoDescription:
        "Source disposable medical masks with quality documentation and stable export supply.",
      sortOrder: 10,
      isFeatured: true,
      defaultFields: {
        model: { valueZh: "MM-01", valueEn: "MM-01", visible: true },
        material: { valueZh: "无纺布", valueEn: "Non-woven fabric", visible: true },
        moq: { valueZh: "50000 只", valueEn: "50000 pcs", visible: true },
    ...
    },
    {
      ...
      shortDescriptionEn:
        "Portable training device for upper and lower limb rehabilitation.",
      detailsZh: "支持阻力调节和折叠收纳，适配机构和家庭康复场景。",
      detailsEn:
        "Features adjustable resistance and foldable design for clinic and home rehab usage.",
      seoTitle: "Portable Rehabilitation Trainer Manufacturer",
      seoDescription:
        "Order portable rehabilitation trainers for therapy centers and home care channels.",
      sortOrder: 20,
      isFeatured: false,
      defaultFields: {
        model: { valueZh: "RT-08", valueEn: "RT-08", visible: true },
        material: { valueZh: "ABS + 钢结构", valueEn: "ABS + steel frame", visible: true },
        moq: { valueZh: "200 台", valueEn: "200 units", visible: true },
  ...
  blogPosts: [
    {
      ...
      excerptEn:
        "A checklist that helps buyers and distributors pass import reviews faster.",
      contentZh: "建议提前准备测试报告、批次追溯记录、标签规范和合规声明。",
      contentEn:
        "Prepare testing reports, batch traceability records, label standards, and declarations of conformity in advance.",
      categorySlug: "compliance-quality",
      tags: ["medical", "compliance"],
      publishedAt: "2026-04-11T09:00:00.000Z",
    },
  ],
  featuredCategorySlugs: ["medical-consumables", "rehabilitation-devices"],
  featuredProductSlugs: ["disposable-medical-mask"],
};
