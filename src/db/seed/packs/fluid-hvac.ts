    ...
    home: [
      {
        ...
        payloadJson: {
          ...
          description:
            "Delivering chillers, air handling systems, and valve assemblies with engineering support.",
      ...
      },
      {
        ...
        sortOrder: 30,
        payloadJson: {
          slugs: ["hvac-equipment", "fluid-control-components"],
        },
      },
    ],
    about: [
      {
        ...
        payloadJson: {
          ...
          description:
            "From thermal calculation to assembly testing, we help buyers reduce delivery risks.",
        },
      },
    ],
    contact: [
      {
        ...
        payloadJson: {
          ...
          description:
            "Send project specs, operating conditions, and target market for a tailored proposal.",
        },
      },
    ],
  },
  ...
  products: [
    {
      ...
      shortDescriptionEn:
        "High-efficiency modular chiller for commercial building cooling systems.",
      detailsZh: "支持多机并联和智能控制，便于分期建设项目部署。",
      detailsEn:
        "Supports multi-unit parallel operation and smart control for phased project deployment.",
      seoTitle: "Air-Cooled Modular Chiller Supplier",
      seoDescription:
        "Deploy modular chillers with smart controls and export-ready support for commercial HVAC projects.",
      sortOrder: 10,
      isFeatured: true,
      defaultFields: {
        model: { valueZh: "AMC-180", valueEn: "AMC-180", visible: true },
        application: { valueZh: "商业建筑制冷", valueEn: "Commercial cooling", visible: true },
        moq: { valueZh: "1 套", valueEn: "1 set", visible: true },
        lead_time: { valueZh: "25-30 天", valueEn: "25-30 days", visible: true },
      },
      customFields: [
        {
          labelZh: "制冷量",
    ...
    },
    {
      ...
      shortDescriptionEn:
        "Motorized control valve assembly for HVAC and industrial fluid systems.",
      detailsZh: "支持多口径和执行器选型，适配楼宇自控系统。",
      detailsEn:
        "Available in multiple diameters with actuator options for BMS integration.",
      seoTitle: "Motorized Control Valve Set Manufacturer",
      seoDescription:
        "Source motorized valve sets with reliable flow control and project integration support.",
      sortOrder: 20,
      isFeatured: false,
      defaultFields: {
        model: { valueZh: "MCV-50", valueEn: "MCV-50", visible: true },
        material: { valueZh: "黄铜 / 不锈钢", valueEn: "Brass / Stainless steel", visible: true },
  ...
  blogPosts: [
    {
      ...
      excerptEn:
        "A practical parameter checklist to reduce redesign and rework risks in HVAC projects.",
      contentZh: "重点包括负荷曲线、工况温度、系统控制方式和维护策略。",
      contentEn:
        "Focus on load profile, operating temperature, control method, and maintenance strategy.",
      categorySlug: "project-sizing",
      tags: ["hvac", "fluid"],
      publishedAt: "2026-04-12T09:00:00.000Z",
    },
  ],
  featuredCategorySlugs: ["hvac-equipment", "fluid-control-components"],
  featuredProductSlugs: ["air-cooled-modular-chiller"],
};
