    ...
    home: [
      {
        ...
        payloadJson: {
          ...
          description:
            "Providing high-efficiency lighting fixtures with flexible OEM/ODM support and export compliance.",
      ...
      },
      {
        ...
        sortOrder: 30,
        payloadJson: {
          slugs: ["commercial-lighting", "industrial-lighting"],
        },
      },
    ],
    about: [
      {
        ...
        payloadJson: {
          ...
          description:
            "In-house engineering and production workflow helps buyers launch projects faster.",
        },
      },
    ],
    contact: [
      {
        ...
        payloadJson: {
          ...
          description:
            "Send fixture requirements, certification needs, and destination market for quick quoting.",
        },
      },
    ],
  },
  ...
  products: [
    {
      ...
      shortDescriptionEn:
        "Modular LED linear fixture for office and retail lighting projects.",
      detailsZh: "支持多长度拼接和多种色温，便于项目标准化部署。",
      detailsEn:
        "Supports multi-length connection and color temperature options for standardized deployment.",
      seoTitle: "LED Linear Light Manufacturer",
      seoDescription:
        "Source modular LED linear lights with project-friendly configurations and export support.",
      sortOrder: 10,
      isFeatured: true,
      defaultFields: {
        model: { valueZh: "LL-1200", valueEn: "LL-1200", visible: true },
        material: { valueZh: "铝型材 + PC", valueEn: "Aluminum + PC", visible: true },
    ...
    },
    {
      ...
      shortDescriptionEn:
        "LED high-bay fixture for warehouse and industrial facility lighting.",
      detailsZh: "支持不同功率和配光角度，满足多种安装高度需求。",
      detailsEn:
        "Available in multiple wattages and beam angles for different mounting heights.",
      seoTitle: "High Bay Industrial Light Supplier",
      seoDescription:
        "Deploy durable LED high-bay lights for industrial and warehouse lighting projects.",
      sortOrder: 20,
      isFeatured: false,
      defaultFields: {
        model: { valueZh: "HB-200", valueEn: "HB-200", visible: true },
        application: { valueZh: "工业与仓储", valueEn: "Industrial and warehouse", visible: true },
        moq: { valueZh: "300 套", valueEn: "300 sets", visible: true },
  ...
  blogPosts: [
    {
      ...
      excerptEn:
        "Avoid glare, under-illumination, and high maintenance costs during lighting planning.",
      contentZh: "建议优先核对照度需求、显指、UGR 和驱动稳定性等关键指标。",
      contentEn:
        "Prioritize illuminance targets, CRI, UGR, and driver stability in early-stage selection.",
      categorySlug: "lighting-design",
      tags: ["lighting", "project"],
      publishedAt: "2026-04-13T09:00:00.000Z",
    },
  ],
  featuredCategorySlugs: ["commercial-lighting", "industrial-lighting"],
  featuredProductSlugs: ["led-linear-light"],
};
