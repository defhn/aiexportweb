...
const planCards: PlanCardSummary[] = [
  ...
  },
  {
    ...
    descriptionZh:
      "适合已经有销售动作，想用 AI 加快产品录入、询盘分类和回复效率的团队。",
  },
];
...
const featureRules: Record<FeatureKey, FeatureRule> = {
  ...
  utm_attribution: {
    labelZh: "流量归因看板",
    requiredPlan: "growth",
    upgradeTitle: "流量归因看板属于获客版功能",
    upgradeDescription:
      "升级后可看到每个询盘的流量来源（Google / 展会 / 邮件），广告系列转化效果和 GCLID 明细，帮助老板判断哪个渠道值得加大投入。",
    benefits: [
      "看到询盘是从 Google 搜索、展会名片还是广告进来的",
      "判断广告投放是否带来真实询盘，而不是压低成本",
      "精准展示 GCLID 广告点击来源的高意向客户",
    ],
  },
  pipeline_kanban: {
    labelZh: "Pipeline 线索看板",
    requiredPlan: "growth",
    upgradeTitle: "Pipeline 看板属于获客版功能",
    upgradeDescription:
      "升级后可以用 Kanban 一览查看所有线索的跟进阶段，并追踪赢单率和预期收入。",
    benefits: [
      "一屏看清所有热进线索处于哪层 Kanban",
      "能看到赢单率并评估各阶段转化效率",
      "外贸老板可实时掌握整个销售漏斗进展",
    ],
  },
  ...
  rag_factory: {
    labelZh: "RAG 知识工厂",
    requiredPlan: "ai_sales",
    upgradeTitle: "RAG 知识工厂属于 AI 销售版独家功能",
    upgradeDescription:
      "升级后 AI 生成的所有内容都将基于您自己的产品知识库，并自动标红与知识库矛盾的技术参数。",
    benefits: [
      "AI 内容不再采用权威得不到的数据，全部来自展示商自身产品资料",
      "内容发布前可一键核查技术参数准确性，防止 AI 幻觉上线",
      "向量语义搜索比关键词匹配更局住上下文",
    ],
  },
};
...
const comparisonSections: ComparisonSection[] = [
  {
    ...
    rows: [
      ...
      { label: "JSON-LD 结构化数据（Product / Organization / Blog）", basic: true, growth: true, ai_sales: true },
    ],
  },
  {
    title: "获客与运营",
    rows: [
      ...
      { label: "附件安全下载（预签名链接 15 分钟）", basic: false, growth: true, ai_sales: true },
      ...
      { label: "全链路 UTM 追踪（utm_source / medium / campaign / gclid）", basic: false, growth: true, ai_sales: true },
    ],
  },
  {
    title: "销售协同与 CRM",
    rows: [
      ...
      { label: "流量归因看板（UTM 来源 + 广告系列分析）", basic: false, growth: true, ai_sales: true },
      { label: "Pipeline 看板（6 阶段 Kanban 线索跨阶）", basic: false, growth: true, ai_sales: true },
      { label: "询盘 CSV 导出", basic: false, growth: true, ai_sales: true },
    ],
  },
  {
    title: "AI 功能",
    rows: [
      ...
      { label: "RAG 知识工厂（私有知识库生成）", basic: false, growth: false, ai_sales: true },
      { label: "AI 事实核查（技术参数矛盾自动标红）", basic: false, growth: false, ai_sales: true },
      { label: "向量语义检索（embedding-004）", basic: false, growth: false, ai_sales: true },
    ],
  },
];
