  ...
  return (
    <div className="space-y-6">
      <section className="rounded-[2rem] border border-stone-200 bg-white p-8 shadow-sm">
        <h2 className="text-2xl font-semibold text-stone-950">CSV 批量导入产品</h2>
        <p className="mt-3 max-w-2xl text-sm leading-6 text-stone-600">
          使用 CSV 文件一次性导入产品数据，适合快速初始化目录或批量录入基础产品信息。
        </p>
      </section>

      <section className="rounded-[1.5rem] border border-stone-200 bg-white p-6 shadow-sm">
        <h3 className="text-lg font-semibold text-stone-950">示例 CSV 格式</h3>
        <p className="mt-3 text-sm leading-6 text-stone-600">
          目前支持这些基础字段：`name_zh`、`name_en`、`category`、`material`、`process`、`moq`、
