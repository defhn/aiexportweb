...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return buildPageMetadata({
    title: seoTitle || "About Us — CNC Precision Manufacturing",
    description: seoDescription || "Learn about our CNC manufacturing capabilities, quality systems, and global export experience.",
    path: "/about",
  });
}
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="relative h-[60vh] min-h-[500px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6 text-center mt-16">
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold tracking-tighter text-white max-w-4xl mx-auto leading-[1.1]">
      ...
      <section className="relative z-20 -mt-8 sm:-mt-16 mx-auto max-w-5xl px-6">
        <div className="bg-white rounded-3xl shadow-2xl border border-stone-100 p-8 flex flex-col md:flex-row justify-between divide-y md:divide-y-0 md:divide-x divide-stone-100">
            <div className="flex-1 text-center py-4 md:py-0">
                <p className="text-4xl sm:text-5xl font-black text-stone-900 tracking-tighter">15k<span className="text-blue-500 text-3xl">+</span></p>
                <p className="text-xs font-bold uppercase tracking-widest text-stone-400 mt-2">SQ.M Facility</p>
            </div>
            <div className="flex-1 text-center py-4 md:py-0">
                <p className="text-4xl sm:text-5xl font-black text-stone-900 tracking-tighter">150<span className="text-blue-500 text-3xl">+</span></p>
                <p className="text-xs font-bold uppercase tracking-widest text-stone-400 mt-2">CNC Machines</p>
            </div>
            <div className="flex-1 text-center py-4 md:py-0">
                <p className="text-4xl sm:text-5xl font-black text-stone-900 tracking-tighter">24<span className="text-blue-500 text-3xl">/</span>7</p>
                <p className="text-xs font-bold uppercase tracking-widest text-stone-400 mt-2">Operations</p>
            </div>
            <div className="flex-1 text-center py-4 md:py-0">
                <p className="text-4xl sm:text-5xl font-black text-stone-900 tracking-tighter">15<span className="text-blue-500 text-3xl">Yr</span></p>
      ...
      <section className="py-24 md:py-32 bg-white">
        <div className="mx-auto max-w-7xl px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 lg:order-2">
                <h2 className="text-sm font-black uppercase tracking-[0.4em] text-blue-600 mb-4">Our Heritage</h2>
                <h3 className="text-3xl md:text-5xl font-bold tracking-tight text-stone-900 leading-[1.1] mb-6">
                ...
                <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 gap-8">
                    <div>
                        ...
                        <h4 className="font-bold text-stone-900 mb-2">Absolute Precision</h4>
                    ...
                    <div>
                        ...
                        <h4 className="font-bold text-stone-900 mb-2">Agile Production</h4>
      ...
      <section className="py-32 bg-stone-50 border-t border-stone-100 relative">
        <div className="mx-auto max-w-7xl px-6">
            <div className="text-center max-w-2xl mx-auto mb-16">
                ...
                <h2 className="text-3xl md:text-4xl font-bold tracking-tight text-stone-900">Trusted Across Continents</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-white p-8 rounded-3xl border border-stone-100 shadow-sm flex items-start gap-4">
                    ...
                    <div>
                        <h3 className="font-bold text-stone-900">North America Logistics</h3>
                ...
                <div className="bg-white p-8 rounded-3xl border border-stone-100 shadow-sm flex items-start gap-4">
                    ...
                    <div>
                        <h3 className="font-bold text-stone-900">European Distribution</h3>
