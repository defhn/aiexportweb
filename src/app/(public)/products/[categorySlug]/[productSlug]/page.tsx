    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="mx-auto max-w-7xl px-6 py-16">
        <div className="grid gap-12 lg:gap-16 lg:grid-cols-[1fr_400px]">
          {/* Sticky Sidebar: Inquiry — 移动端置顶，桌面端在右侧 */}
          ...
          <div className="space-y-16">
            ...
            <div className="space-y-12">
                ...
                {product.showDownloadButton && product.pdfUrl && (
                    <div className="flex items-center justify-between p-6 md:p-10 bg-stone-900 rounded-[2.5rem] shadow-2xl overflow-hidden relative group">
