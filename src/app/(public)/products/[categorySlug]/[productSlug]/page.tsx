        ...
        <div className="grid gap-12 lg:grid-cols-[1fr_420px] lg:gap-20">
          ...
          <aside className="relative">
            <div className="sticky top-24 space-y-12">
              <div 
                className="relative overflow-hidden rounded-[2.5rem] border p-1 shadow-2xl transition-all duration-500 hover:shadow-[0_40px_80px_-20px_var(--glow)]" 
                style={{ borderColor: theme.border, backgroundColor: theme.surfaceAlt, '--glow': theme.accentSoft } as React.CSSProperties}
              >
