...
function buildDetails(spec: ProductSpec, language: "zh" | "en") {
  if (language === "zh") {
    return [
      spec.detailLeadZh,
      `支持 ${spec.processZh} 工艺，常用材料为 ${spec.materialZh}，标准公差可控制在 ${spec.tolerance}。`,
      `产品主要应用于 ${spec.applicationZh}，常规交期 ${spec.leadTime}，可配合样品开发与批量交付。`,
    ].join("\n\n");
  }
...
const productSpecs: ProductSpec[] = [
  ...
  },
  {
    ...
    customFields: [
      { labelZh: "同轴度", labelEn: "Concentricity", valueZh: "0.01 mm", valueEn: "0.01 mm", visible: true, sortOrder: 10 },
      { labelZh: "硬化方式", labelEn: "Heat Treatment", valueZh: "高频淬火可选", valueEn: "Optional induction hardening", visible: true, sortOrder: 20 },
    ],
    shape: "shaft",
    tone: "steel",
    sceneAccent: "#38bdf8",
  ...
  },
  {
    ...
    customFields: [
      ...
      { labelZh: "粗糙度", labelEn: "Surface Roughness", valueZh: "Ra 0.8", valueEn: "Ra 0.8", visible: true, sortOrder: 20 },
    ],
    shape: "connector",
    tone: "brass",
    sceneAccent: "#eab308",
  ...
  },
  {
    ...
    customFields: [
      ...
      { labelZh: "检测方式", labelEn: "Inspection", valueZh: "气动量仪抽检", valueEn: "Air gauge inspection", visible: true, sortOrder: 20 },
    ],
    shape: "bushing",
    tone: "steel",
    sceneAccent: "#a855f7",
  ...
  },
  {
    ...
    certification: "RoHS",
    customFields: [
      { labelZh: "导热要求", labelEn: "Thermal Requirement", valueZh: "底面平整度优先", valueEn: "Priority on flat thermal contact", visible: true, sortOrder: 10 },
  ...
  },
  {
    ...
    colorZh: "黑色",
    colorEn: "Black",
    applicationZh: "自动化夹具、滑台安装、视觉相机基座",
